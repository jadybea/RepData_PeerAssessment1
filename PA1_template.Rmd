...
The **median** of the total number of steps taken daily is `r daily_median`. 

The **mean** of the total number of steps taken daily is `r daily_mean`.
...
The 5-minute **interval, that contains the maximum number of steps** is the interval `r max_interval`.
...
In the original dataset, there are `r NA_number` **missing values**, i.e. there are `r NA_number` 5-minute intervals, for which no measurement of steps were performed. 
...
After filling in the missing values, the **median** of the total number of steps taken daily is `r daily_median2`. 

The **mean** of the total number of steps taken daily is `r daily_mean2`.
